...
3.1.1.2 [Ознакомление с правилами](#locate_user)  
3.1.1.3 [Присоедение/отсоединение от комнаты](#view_and_update_user)  
3.1.1.4 [Создание своей комнаты](#choose_information_about_trip)  
3.1.1.5 [Покидание партии](#preview_trip)  
3.1.1.6 [Возможность взять карточку](#navigate_user_during_trip)  
3.1.1.7 [Ход](#finish_trip)  
3.1.1.8 [Конец игры](#statistics_of_other_users)  
...
#### 3.1.1.2 Ознакомление с правилами
**Описание.** После входа пользователя в приложение имеет возможность ознакомиться с правилами игры. 

**Требование.** Приложение должно отобразить правила.

<a name="view_and_update_user"/>

#### 3.1.1.3 Присоединение/отсоединение от комнаты
**Описание.** Зарегистрированный пользователь имеет возможность присоединится/отключиться от существующей комнаты.

**Требование.** Пользователю должна отобразится информация(кол-во игроков в комнате, количетсво карточек) о комнате,к которой он присоединлся. В случае отключения отображаются все дступные для присоединения комнаты.

<a name="choose_information_about_trip"/>

#### 3.1.1.4 Создание своей комнаты
**Описание.** Пользователь имеет возможность создать свою комнату с найстройками игры. При отключении роль хоста(владельа комнаты) передаётся другому игроку.Если игрока нету,команта удаляется.

**Требование.** Пользователю должно отобразиться окно создания комнаты.

<a name="preview_trip"/>

#### 3.1.1.5 Покидание партии
**Описание.** Пользователь имеет возможность покинуть игру

**Требование.** Приложение должно игроку покинуть игру во время матча. Для покидания нужно подтвердить действие.

<a name="navigate_user_during_trip"/>

#### 3.1.1.6 Возможность взять карточку
**Описание.** Приложение должно предоставить пользователю возможность взять карточку для хода. В случае отсутсвия карточек игра заканчивается

**Требование.** Приложение должно предоставить пользователю возможность взять карточку: отобразить графическое отображение карточки.

<a name="finish_trip"/>

#### 3.1.1.7 Ход
**Описание.** Пользователь должен иметь возможность крутить, положить вытянутую им карточку.

<a name="statistics_of_other_users"/>

#### 3.1.1.8 Конец игры 
**Описание.** Пользователи  должны иметь возможность просмотра информации об игре.

**Требование.** Приложение должно предоставить игрокам статистику матча: места игроков и их очки. 
