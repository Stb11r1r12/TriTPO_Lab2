...
3.1.1.2 [Ознакомление с правилами](#rules)  
3.1.1.3 [Присоедение/отсоединение от комнаты](#join_disconnect)  
3.1.1.4 [Создание своей комнаты](#create)  
3.1.1.5 [Покидание партии](#leave)  
3.1.1.6 [Возможность взять карточку](#take)  
3.1.1.7 [Ход](#make_step)  
3.1.1.8 [Конец игры](#end_of_game)  
...
4. Обновление стала партии в режиме реального времени;
